...
<?php
if ($hero_banner->have_posts()) : while($hero_banner->have_posts()) : $hero_banner->the_post(); ?>


<!-- Intermediate Banner -->

<section
    id="banner-intermediate-123" class="qld__banner qld__banner__intermediate qld__banner--dark qld__banner--breadcrumbs qld__banner--has-hero card">
        ...
        <div class="qld__banner__wrapper">
            <div class="qld__banner__main row">
                ...
                <?php                    
                    ...
                    ?>
                    <div class="qld__banner__image qld__banner__image--mobile-hide" style="background-image: url('<?php echo $displayPgBannerImg ?>');"></div>
                    <div class="qld__banner__image qld__banner__image--background qld__banner__image--desktop-hide" style="background-image: url('<?php echo $displayPgBannerImg ?>" alt="<?php echo esc_attr(get_the_title());?>" title="<?echo $img_title ?>');"></div>
